...
export default function OggToMp3() {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const inputName = `input.${audioFile.name.split(".").pop() || "ogg"}`;
      ...
      setResult({
        ...
        url,
        stats: [
          { label: "Original Duration", value: formatTime(metadata?.duration || 0), sub: "Original file" },
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <main id="main-content" tabIndex={-1} className="pt-28">
        <div className="mx-auto max-w-[1400px] px-6 pb-24">
          ...
          <div className="mb-12">
            <h1 className="text-6xl font-black uppercase">Ogg to Mp3</h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8 items-start">
            <div className="space-y-6">
              {!audioFile ? (
                <AudioUploadZone onFilesSelected={handleFileSelected} accept="audio/ogg,.ogg" />
              ) : (
