...
export default function FadeInAudio() {
  ...
  async function handleFade() {
    ...
    try {
      ...
      await ffmpeg.exec(["-i", inputName, "-af", `afade=t=in:ss=0:d=${fadeSec}`, "-c:a", "libmp3lame", "-b:a", "192k", outputName]);
      ...
      setResult({
        ...
        url,
        stats: [
          { label: "Fade In", value: `${fadeSec}s` },
          { label: "Output Size", value: formatFileSize(blob.size) },
        ],
      });
    } catch (e) {
      console.error(e);
      setError(e?.message || "Fade in failed");
    } finally {
      setLoading(false);
      setProgress(0);
    }
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <main className="pt-28">
        <div className="mx-auto max-w-[1400px] px-6 pb-24">
          ...
          <div className="mb-12">
            <h1 className="text-6xl font-black uppercase">Fade In</h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8 items-start">
            <div className="space-y-6">
              ...
              >
                {loading ? "Applying..." : "Apply Fade In"}
              </button>
            </div>
            <div className="space-y-6">
          ...
          {result && (
            <div className="mt-10">
              <AudioResultCard
                ...
                url={result.url}
                stats={result.stats}
                downloadLabel="Download Fade In Audio"
